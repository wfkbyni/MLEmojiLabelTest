...
争知我、倚阑干处，正恁凝愁"];
        ...
        //[_emojiLabel3 setText:attString];
...
#warning tips，刚刚发现在此block里 iOS8下不支持NSForegroundColorAttributeName属性，请使用kCTForegroundColorAttributeName
        [_emojiLabel3 setText:attString afterInheritingLabelAttributesAndConfiguringWithBlock:^NSMutableAttributedString *(NSMutableAttributedString *mutableAttributedString) {
            ...
            [mutableAttributedString addAttribute:(NSString *)kCTForegroundColorAttributeName value:[UIColor colorWithRed:0.313 green:0.479 blue:1.000 alpha:1.000] range:NSMakeRange(6, 2)];
        ...
        _emojiLabel3.delegate = self;
        //[_emojiLabel3 addLinkToURL:[NSURL URLWithString:@"http://sasasadan.com"] withRange:[_emojiLabel3.text rangeOfString:@"对潇潇暮"]];
        //[_emojiLabel3 addLinkToURL:[NSURL URLWithString:@"http://sasasadan.com"] withRange:NSMakeRange(6, 2)];
        
        NSDictionary* dic1 = @{@"name":@"sych",@"id":@"10001"};
        
        [_emojiLabel3 addLinkToTransitInformation:dic1 withRange:[_emojiLabel3.text rangeOfString:@"对潇潇暮"]];
        
        NSDictionary* dic2 = @{@"name":@"wfkbyni",@"id":@"10002"};
        [_emojiLabel3 addLinkToTransitInformation:dic2 withRange:NSMakeRange(6, 2)];
